...
const Login = () => {
  return (
    <div>
      <div className="w-screen h-full px-20 m-19 flex flex-row bg-white ">
        <div className="w-1/3 h-full py-30  basis-1/3  ">
          ...
          <div className=" px-2 flex justify-center   py-2">
            ...
            <a href="#" className="py-4 ml-5 underline">
              Login
            </a>
          </div>
          <div className=" flex justify-center items-center h-70    w-full">
            <form>
              <h1 className="py-3 font-semibold text-md">Username</h1>
              <input
                type="text"
                placeholder="  Username"
                className=" h-10 w-[50vh] rounded-md border-[1px]"
              />
              <h1 className="py-3 font-semibold text-md">Email</h1>
              <input
                type="email"
                placeholder="Email"
                className=" h-10 w-[50vh] rounded-md border-[1px]"
              />
              <h1 className="py-3 font-semibold text-md"> Password</h1>
              <input
                type="password"
        ...
        "Thoughts become words, words become stories, and stories shape the world. Let’s create something meaningful together."
        </h1>
        <h3 className="px-18 mt-[-14vh] font-bold">
        "Gyouko"
        </h3>
